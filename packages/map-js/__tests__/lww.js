...
de(
  map(array_ron),
  Object.assign(JSON.parse('[0,"1",1,2,{"$ref":"notexists"}]'), {_id: 'array'}),
);
...
de(
  map(array_ref),
  Object.assign(JSON.parse('[1,2,{"$ref":"arr"}]'), {_id: 'ref'}),
);
...
de(
  map(with_refs),
  JSON.parse(
    '{"one":{"key":"value","_id":"left"},"two":{"number":42,"_id":"right"},"_id":"root"}',
  ),
);
