...
},{"../../lib/Host":2,"../../lib/Html5Client.js":3,"../../lib/SharedWebStorage":7,"../../lib/Text":11,"../../lib/env":13}],2:[function(require,module,exports){
var env = require('./env');
...
},{"./Pipe":5,"./Spec":8,"./Syncable":10,"./env":13}],3:[function(require,module,exports){
...
},{"./Host":2,"./Model":4,"./Pipe":5,"./Set":6,"./SharedWebStorage":7,"./Spec":8,"./Storage":9,"./Syncable":10,"./WebSocketStream":12,"./env":13}],4:[function(require,module,exports){
var Spec = require('./Spec');
var Syncable = require('./Syncable');
...
},{"./Spec":8,"./Syncable":10}],5:[function(require,module,exports){
var env = require('./env');
var Spec = require('./Spec');
...
},{"./Spec":8,"./env":13}],6:[function(require,module,exports){
var env = require('./env');
var Spec = require('./Spec');
var Syncable = require('./Syncable');
...
},{"./Model":4,"./Spec":8,"./Syncable":10,"./env":13}],7:[function(require,module,exports){
var env = require('./env');
var Spec = require('./Spec');
var Syncable = require('./Syncable');
...
},{"./Host":2,"./Spec":8,"./Syncable":10,"./env":13}],8:[function(require,module,exports){
//  S P E C I F I E R
//
...
},{"./Host":2,"./Spec":8,"./Syncable":10}],10:[function(require,module,exports){
var Spec = require('./Spec');
var env = require('./env');
...
},{"./Spec":8,"./env":13}],11:[function(require,module,exports){
var env = require('./env');
var Spec = require('./Spec');
var Syncable = require('./Syncable');

Text = module.exports = Syncable.extend('Text',{
                ...
                if (id in ins) {
                    ...
                    if (k > i + 1) { // concurrent edits
                        ...
                        for (var j = 0; j < str.length; j++) {
                            ...
                            if (!seqi) seqi = 1; // FIXME repeat ids, double insert
                        }
                    }
                }
            }
    ...
    set: function (newText) {
        ...
        var rm = null, ins = null, pos = 0, weave=this.weave;
        var re_atom = /[^\u0008][\u0008]*/mg;
        var atom = re_atom.exec(this.weave); // \n #00000+swarm

        function skip (n) {
            n=n||1;
            while (n && (atom=re_atom.exec(weave)))
                if (atom[0].length===1)
                    n--;
        }
...
},{"./Spec":8,"./Syncable":10,"./env":13}],12:[function(require,module,exports){
var env = require('./env');
...
},{"./env":13}],13:[function(require,module,exports){
