...
IdArray.prototype._next = function (i) {
    ...
    i.prev =  this._uncompress(i.match[0],i.prev);
...
IdArray.prototype._find = function (uid, startOffset) {
    // seek full form matching ts0
    // then iterate
};
