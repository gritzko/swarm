...
exports = ( function () {
    ...
    */
    ...
    EventRelay.extend(EventRelay,{ // :)
        ...
        err: function (spec,val,lstn) {
            console.error('error received: ',val,' by ',this.scope());
        },
    ...
    EventRelay.extend(View, {
        ...
        init : function viewInit(id) {
            ...
            if (this.template && !this.tmplFn) // FIXME proto
        ...
        set: function (spec,val,lstn) {
            ...
            if (this._lstn || this._reactions)
                this.emit(this.scope(),this.html,lstn);
        },
