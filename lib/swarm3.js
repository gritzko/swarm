...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['exports'], function(exports) {
            ...
            root.Swarm = factory(root, exports);
        });
    ...
    // Finally, as a browser global.
        ...
        console.log('3');
        root.Swarm = factory(root, {});
    }

} (this, function(root, Swarm) {
    ...
    Syncable.extend(Syncable,{  // :P
        ...
        deliver: function (spec,value,lstn) {
            ...
            if (pattern==='/#!.') {
                ...
                var specs = [];
                for (var sp in value) if (value.hasOwnProperty(sp)) {
        ...
        __off: function (spec,val,repl) {
            ...
            if (i===ls.length) { throw new Error("listener unknown"); }
            ls[i] = undefined;
        ...
        */
        $_init: function (spec,snapshot,host) {
            if (this._id===spec.version() && !snapshot._oplog) { // new fresh object  TODO nicer
                ...
                for (sp in this._oplog) if (this._oplog.hasOwnProperty(sp)) {
