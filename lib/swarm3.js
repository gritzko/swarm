(function(root, factory) {
    ...
    var Model = Swarm.Model = Syncable.extend('Model',{
        ...
        */
        ...
        /// FIXME FIXME FIXME   should use only the distilledLog, not .init
        diff: function (base) {
            var spec,
                ret = null;
            if (base && base!='!0') { // diff sync
                ...
                if (this._version) {
                    ...
                    var pos = this._version.indexOf('!'),
                        key = '!' + (pos > -1 ? this._version.substr(0, pos) : this._version) + '.init'; /// FIXME SOOO UGLY
                    ret[key] = this.pojo();
                    ret[key]._oplog = {};
