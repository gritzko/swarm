...
Swarm = (typeof('require')==='function') ? exports : {};
console.error(Swarm);
Swarm.Spec = Spec;
...
Syncable.extend(Syncable,{  // :P
    ...
    stateSpec: function () {
        return this.spec() + (this._version?'!'+this._version:''); //?
    },
    ...
    neutrals: {
        ...
        error: function (spec,val,repl) {
            console.error('something failed: '+spec+' at '+repl&&repl._id);
        },
