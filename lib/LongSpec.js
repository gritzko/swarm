...
/** LongSpec is a Long Specifier, i.e. a string of ids that may be
 ...
 * {en:{'/Type':'/T'}, de:{'/T':'/Type'}}. May pass an empty object;
 ...
 * actually a regex math array. Note that it contains encoded tokens.
