...
Syncable.extend(Syncable, {  // :P
    ...
    ops: {
        ...
        init: function (spec, state, src) {
            ...
            /*if (this._version && state._version==='!0') {
                // TODO .4 merciless .init refac
                return; // noop
            }*/
    ...
    checkUplink: function () {
        ...
        for (i = 0; i < new_uplinks.length; i++) {
            ...
            this.addNewUplink(up);
        }
    },

    addNewUplink: function (up) {
        var self = this;
        var onspec = self.newEventSpec('on');
        self._lstn.unshift({
            _op: 'reon',
            _src: up,
        ...
        up.deliver(onspec, self.version().toString(), self);
    },
